...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    companyId: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    level: Schema.Attribute.Enumeration<
      ['internship', 'junior', 'middle', 'senior', 'architect']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNewsletterNewsletter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['one', 'two', 'three']> &
      Schema.Attribute.Required &
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answers: Schema.Attribute.Relation<'manyToOne', 'api::answer.answer'>;
    answerType: Schema.Attribute.Enumeration<['radio', 'select']> &
      Schema.Attribute.Required &
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    frontier: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
